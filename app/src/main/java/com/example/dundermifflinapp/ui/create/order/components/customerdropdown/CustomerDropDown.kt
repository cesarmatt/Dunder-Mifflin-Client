package com.example.dundermifflinapp.ui.create.order.components.customerdropdown
...
fun CustomerDropDownComponent(
    ...
    val setSelectedValue: (DropDownOption) -> Unit = {
        ...
        onCustomerSelected(it.content as Customer)
    }
